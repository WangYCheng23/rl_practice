...
LastEditTime: 2024-05-27 10:32:37
'''
...
quadruped = p.loadURDF(os.path.join(__file__, "../data/laikago/urdf/laikago.urdf"),[0,0,0.48],[0,0,0,1], flags = urdfFlags,useFixedBase=False)
